...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2020 at 12:24 PM
...
(1, 'marie gold', 40, 20, '2020-05-31', '', 1),
(2, 'Energy', 40, 25, '2020-05-31', '', 1),
...
(9, 'pepsi (500ml)', 25, 25, '2020-05-31', '', 5),
(10, '7up (500ml)', 20, 25, '2020-05-31', '', 5);
...
INSERT INTO `shop_order` (`p_id`, `name`, `unit_price`, `unit_qty`, `expire_date`, `image`, `category_id`) VALUES
(1, 'coca-cola (600ml)', 40, 20, '2020-05-31', '', 5);
...
--
ALTER TABLE `products`
  MODIFY `p_id` int(5) NOT NULL AUTO_INCREMENT COMMENT '1', AUTO_INCREMENT=11;
